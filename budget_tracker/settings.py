...
ALLOWED_HOSTS = ['localhost', '127.0.0.1','budget-tracker-backend-1-7iom.onrender.com','https://budget-tracker-frontend-three.vercel.app']  # Add other domains in production
